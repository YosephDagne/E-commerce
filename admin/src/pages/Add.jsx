...
const Add = ({ token }) => {
  ...
  return (
    ...
    >
      <div>
        <p className="mb-2 cursor-pointer">Upload Image</p>
      ...
      <button className="bg-gray-900 text-white px-8 py-2 text-md rounded-lg shadow-md hover:bg-green-500 hover:scale-105 hover:rounded-full transition-all duration-300 ease-in-out active:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-green-500 hover:border-2 hover:border-black">
        ADD
      </button>
    </form>
  );
